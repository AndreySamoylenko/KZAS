...
def dedect_line_pro():
    ...
    dat1 = (black_search_left(d1)[4] + black_search_left(d2)[4]) // 5
    dat2 = (black_search_right(d3, x_line_dat[1])[4] + black_search_right(d4, x_line_dat[3])[4]) // 5


def draw_contour_line():
    l1 = black_search_left(frame[y_line_dat[0]:y_line_dat[1], x_line_dat[0]:x_line_dat[1]])
    l2 = black_search_left(frame[y_line_dat[2]:y_line_dat[3], x_line_dat[2]:x_line_dat[3]])
    l3 = black_search_right(frame[y_line_dat[4]:y_line_dat[5], x_line_dat[4]:x_line_dat[5]], 100)
    l4 = black_search_right(frame[y_line_dat[6]:y_line_dat[7], x_line_dat[6]:x_line_dat[7]], 200)
