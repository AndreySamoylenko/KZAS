...
# sock.setblocking(1)
server_address_udp_turbo = ('192.168.10.1', 5001)
server_address_udp_event = ('192.168.10.1', 5003)
server_address_udp_command = ('192.168.10.1', 4999)
...
list_combobox.append(["7", "192.168.10.1", "robot", "l"])
