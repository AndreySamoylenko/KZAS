...
With the "video" button you can display the video from the robot's camera on the screen of your laptop in a separate window on the same window there will be telemetry displayed in the downloaded program.
