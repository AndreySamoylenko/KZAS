...
Сначала вам нужно включить питание робота и подождать какое-то время, это нужно для того чтобы на распберри запустилась операционная система, и включилась точка доступа. 
